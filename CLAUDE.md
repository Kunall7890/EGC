...
> Do not create new files anywhere — not in the project, not in any external vault or notebook.
> `update_state` merges into an existing state file; no new files are ever needed.
